...
void setup()
{
  Serial.begin(115200);             // Inicializa a comunicaçao Serial
...
void loop()
{
  Reader();  //Chama a funçao responsável por fazer a leitura das Tag's
}
...
void Reader()
{
        ...
        // Pega o ID da Tag através da funçao LeitorRFID.uid e Armazena o ID na variável IDtag
...
void acessoLiberado()
{
      ...
      if(IDtag != CardStop)
      {
          efeitoPermitido();  //Chama a funçao efeitoPermitido().
          CartaoPositivo();
          CartaoNegativo();
          Stop();
      }
