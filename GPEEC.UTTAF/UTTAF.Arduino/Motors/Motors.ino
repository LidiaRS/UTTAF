...
int ValorCorte_E = 150; //se o valor for menor do que 150, o valor lido é linha branca, senao estará no preto (Ajustado previamente)
int ValorCorte_D = 150; //se o valor for menor do que 150, o valor lido é linha branca, senao estará no preto (Ajustado previamente)
...
void setup() 
{
	//Para o Shied a biblioteca se encarrega de setar entradas e sa�das!
...
//OBS também é possível criar funçoes para os motores
